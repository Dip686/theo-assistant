...
export const HAIR_STRAND = '#2A2A3E'
export const EYE_WHITE = '#FFFFFF'
export const EYE_PUPIL = '#1A1A2E'
export const EYE_IRIS = '#1A1A2E'
export const MOUTH = '#C1553A'
export const MOUTH_HI = '#C1553A'
export const BLUSH = '#DBA05A'
export const GLASSES = ''
export const GLASSES_HI = ''
export const EYEBROW = '#2A2A3E'
export const JEANS = '#3D4F6F'
export const JEANS_SHADOW = '#2D3F5F'
export const SHOE = '#E8E8E8'
export const SHOE_SHADOW = '#CCCCCC'
export const DRESS = '#3D4F6F'
export const DRESS_SHADOW = '#2D3F5F'
export const DRESS_HI = '#4D5F7F'
export const FLOWER_DOT = ''
